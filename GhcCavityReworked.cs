...
namespace DiggerBee
{
    public class GhcCavityReworked : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GhcCavityReworked class.
        /// </summary>
        public GhcCavityReworked()
          : base("CavityReworked", "CavityRW",
              "Cavity Reworked",
              "DiggerBee", "Geometry")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                CavityReworked c = new CavityReworked(ci[i], multiplicator[i], cInfo);
